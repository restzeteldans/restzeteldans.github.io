// This file contains the parsed SVG data for all Dutch municipalities
// Data is extracted from the Kiesraad official SVG map

export interface MunicipalitySVGData {
  id: string;
  name: string;
  pathData: string;
}

// Map of GM codes to municipality names
export const gmCodeToName: Record<string, string> = {
  "GM1680": "Aa en Hunze",
  "GM0358": "Aalsmeer",
  "GM0197": "Aalten",
